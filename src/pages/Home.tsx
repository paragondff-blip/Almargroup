...
export default function Home() {
  ...
  const aboutDesc = settings?.aboutDesc || "";
  const corpTitle = settings?.corpTitle || "";
  const corpDesc = settings?.corpDesc || "";
  const mission = settings?.mission || "";
  const vision = settings?.vision || "";
  const corpImage = settings?.corpImage || "";
      ...
      <section className="py-20 bg-gray-50 border-y border-gray-100">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
               A diversified conglomerate committed to excellence, innovation, and sustainable growth across multiple industries.
            </p>
         </div>
         <ImageScrollingStrip />
      </section>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-16 items-center">
               <div className="lg:w-1/2">
                  <span className="text-secondary font-black tracking-widest uppercase text-[10px] italic">Corporate Profile</span>
                  <h2 className="text-4xl md:text-5xl font-black text-primary mt-4 mb-6 leading-[1.1] tracking-tighter">Shaping the Future of Global Enterprise</h2>
                  <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                     At Almar Group, we vision a future where enterprise solutions drive sustainable growth. With over two decades of excellence, we have built an ecosystem of brands that deliver unparalleled value to our consumers worldwide.
                  </p>
                  ...
                  <div className="space-y-6 mb-10">
                     <div className="flex gap-4">
                        ...
                        <div>
                           ...
                           <p className="text-gray-600">To innovate and lead across major industries while maintaining the highest standards of corporate responsibility.</p>
                        </div>
                     </div>
                     <div className="flex gap-4">
                        ...
                        <div>
                           ...
                           <p className="text-gray-600">Becoming the most trusted multinational conglomerate, driving prosperity in every community we touch.</p>
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-xl z-20 max-w-sm glassmorphism">
                     <div className="flex items-center gap-4 mb-2">
                        <div className="flex -space-x-3">
                           {[1,2,3,4].map(i => (
                             <img key={i} src={`https://i.pravatar.cc/100?img=${i}`} className="w-10 h-10 rounded-full border-2 border-white"/>
                           ))}
                        </div>
                        <div>
                           <div className="font-bold text-primary">Global Team</div>
                           <div className="text-sm text-gray-500">10,000+ experts</div>
                        </div>
                     </div>
                  </div>
               </div>
